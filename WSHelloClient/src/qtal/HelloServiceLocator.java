...
public class HelloServiceLocator extends org.apache.axis.client.Service implements qtal.HelloService {
    ...
    private java.lang.String Hello_address = "http://localhost:8080/WSHello/services/Hello";
    ...
    public qtal.Hello getHello(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            qtal.HelloSoapBindingStub _stub = new qtal.HelloSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (qtal.Hello.class.isAssignableFrom(serviceEndpointInterface)) {
                qtal.HelloSoapBindingStub _stub = new qtal.HelloSoapBindingStub(new java.net.URL(Hello_address), this);
                _stub.setPortName(getHelloWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://qtal", "HelloService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://qtal", "Hello"));
        }
