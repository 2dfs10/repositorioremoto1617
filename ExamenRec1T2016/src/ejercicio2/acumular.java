	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (dato.equals("Comprar Libro")) {
			...
			case "Java":
				...
				productoc.precio.add(100);
				SumaValor = SumaValor + 100;

				out.println("el libro comprado es " + nombrelibro + " valor  100");
				break;
			...
			case "MySQL":
				...
				productoc.nombrep.add(nombrelibro);
				productoc.precio.add(150);
				SumaValor = SumaValor + 150;
				out.println("el libro comprado es " + nombrelibro + " valor  150");
				break;

			case "JavaScript":

				productoc.nombrep.add(nombrelibro);
				productoc.precio.add(80);
				SumaValor = SumaValor + 80;
				out.println("el libro comprado es " + nombrelibro + " valor  80");
				break;
			...
			//response.setHeader("Refresh", "2;URL=libros.html");
			response.setHeader("Refresh", "2; URL=" +"../ExamenRec1T2016/ejercicio2/"+"libros.html");
			...
			response.setHeader("Refresh", "5; URL=" +"../ExamenRec1T2016/ejercicio2/"+"libros.html");
		}
	}
